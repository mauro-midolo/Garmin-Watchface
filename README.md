...
|-----------|-------------|
| Centro | Orario (24h o 12h) e data |
| 12:00 | Frequenza cardiaca ❤ |
| 10:30 | Temperatura max/min prevista 🌡 |
| 1:30 | Condizioni meteo attuali ☀ |
| 3:00 | Piani saliti oggi 🪜 |
| 4:30 | Prossimo evento solare (alba o tramonto) |
| 6:00 | Altitudine attuale ▲ |
| 7:30 | Passi effettuati + obiettivo 👟 |
| 9:00 | Batteria residua 🔋 |

Attorno al bordo è presente un **anello delle fasi del giorno**: archi colorati mostrano la durata di notte (blu), crepuscolo (rosso) e luce piena (giallo). Una barretta bianca indica l'ora corrente.
